  ...
  return (
    <div className="space-y-6">
      <DashboardHero
        ...
        subtitle={`${stats.pendingDoctorVerifications} doctor verification(s) pending review.`}
        primaryLabel="Manage Doctors"
        primaryHref="/dashboard/admin/doctors"
        secondaryLabel="View Analytics"
        secondaryHref="/dashboard/admin/analytics"
      />
