...
export default function DoctorPatientDetailPage() {
  ...
  console.log("INPUT DATA:", latest?.input_data);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        <BiomarkerRadarChart prediction={latest} />
            ...
            <CardContent>
              {!family || family.member_count === 0 ? (
                <p className="text-sm text-muted-foreground">
                  No family members recorded for this patient.
                </p>
              ) : (
                <div className="space-y-3">
                  <div className="flex gap-4 text-sm">
                    <div>
                      <span className="font-bold">{family.member_count}</span> members
                    </div>

                    <div>
                      <span className="font-bold">
                        {family.avg_risk_score}%
                      </span>{" "}
                      avg risk
                    </div>
                    ...
                    <div>
                      <span className="font-bold">
                        {family.hereditary_conditions_count}
                      </span>{" "}
                  ...
                  {family.insights.map((insight: any, i: number) => (
                    ...
                    >
                      <Activity className="size-3.5 shrink-0 mt-0.5 text-primary" />
                      {insight}
                    </p>
                  ))}
                </div>
