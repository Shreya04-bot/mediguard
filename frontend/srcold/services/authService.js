...
/** @typedef {{ id: string, name: string, email: string, role: UserRole, avatar?: string, specialty?: string }} AuthUser */
...
/**
 * @param {{ name: string, email: string, password: string, role: "patient"|"doctor", verificationToken: string, medicalLicenseNumber?: string, hospitalAffiliation?: string }} data
